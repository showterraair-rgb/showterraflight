...
export const BD_SENDER_PLACEHOLDER = '+8809617626936';
export const BD_SENDER_HELP = '+880 dedicated sender — enter +88096… or 096…; API converts automatically';
...
export function formatSenderIdOnBlur(value, isMasking = false) {
  ...
  return internationalBdNumber(value) || value.trim();
}
