...
const notificationTemplateSchema = new mongoose.Schema(
  {
    ...
    supplierSmsBody: { type: String, default: '' },
    supplierEmailSubject: { type: String, default: '' },
    supplierEmailBody: { type: String, default: '' },
    supplierWhatsappBody: { type: String, default: '' },
    agentSmsBody: { type: String, default: '' },
    agentEmailSubject: { type: String, default: '' },
    agentEmailBody: { type: String, default: '' },
    agentWhatsappBody: { type: String, default: '' },
