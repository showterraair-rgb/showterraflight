...
export const DEFAULT_WHATSAPP_PARAM_KEYS = {
  ...
  schedule_change: ['customerName', 'bookingNumber', 'route', 'previousDate', 'newDate', 'companyName'],
  agent_booking_submitted: ['agentName', 'bookingRef', 'route', 'totalFare', 'companyName'],
...
export const DEFAULT_NOTIFICATION_TEMPLATES = [
  ...
  },
  {
    ...
    name: 'Schedule / route change',
    smsBody: 'Hello {{customerName}}, booking {{bookingNumber}} ({{route}}) updated. New date: {{newDate}}. Was: {{previousDate}}. — Show Terra Flight',
  ...
  },
  {
    ...
    emailSubject: 'New agent booking — {{bookingRef}}',
    emailBody: 'Agent {{agentName}} submitted booking {{bookingRef}}.\n\nRoute: {{route}}\nTotal: {{totalFare}}\n\nReview in admin panel.',
  },
  {
    templateKey: 'agent_booking_confirmed',
    name: 'Agent booking confirmed',
    smsBody: 'Hello {{agentName}}, booking {{bookingRef}} ({{route}}) is CONFIRMED. Departure: {{departureDate}}. — Show Terra Flight',
    whatsappBody: 'Hello {{agentName}},\n\nBooking {{bookingRef}} is confirmed.\nRoute: {{route}}\nDeparture: {{departureDate}}\n\n— Show Terra Flight',
    emailSubject: 'Booking confirmed — {{bookingRef}}',
    emailBody: 'Hello {{agentName}},\n\nYour booking {{bookingRef}} has been confirmed.\n\nRoute: {{route}}\nDeparture: {{departureDate}}\n\n— Show Terra Flight',
  },
  {
    templateKey: 'agent_booking_cancelled',
    name: 'Agent booking cancelled',
    smsBody: 'Hello {{agentName}}, booking {{bookingRef}} ({{route}}) has been cancelled. — Show Terra Flight',
    whatsappBody: 'Hello {{agentName}},\n\nBooking {{bookingRef}} for {{route}} was cancelled.\n\n— Show Terra Flight',
    emailSubject: 'Booking cancelled — {{bookingRef}}',
    emailBody: 'Hello {{agentName}},\n\nYour booking {{bookingRef}} ({{route}}) has been cancelled.\n\n— Show Terra Flight',
  },
  {
    templateKey: 'agent_booking_ticket_ready',
    name: 'Agent ticket ready',
    smsBody: 'Hello {{agentName}}, ticket for {{bookingRef}} ({{route}}) is ready. PNR: {{pnr}}. Download from agent portal. — Show Terra Flight',
    whatsappBody: 'Hello {{agentName}},\n\nTicket for {{bookingRef}} is ready.\nRoute: {{route}}\nPNR: {{pnr}}\n\n— Show Terra Flight',
    emailSubject: 'Ticket ready — {{bookingRef}}',
    emailBody: 'Hello {{agentName}},\n\nThe ticket for booking {{bookingRef}} is ready.\n\nRoute: {{route}}\nPNR: {{pnr}}\n\nLog in to the agent portal to download.',
  },
];

export const DEFAULT_AUTOMATION_RULES = [
  { eventType: 'website_order_created', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'admin_new_booking_alert', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: false, isEnabled: true },
  { eventType: 'admin_manual_order_alert', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: false, isEnabled: true },
  { eventType: 'admin_manual_booking_alert', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: false, isEnabled: true },
  { eventType: 'approval_pending', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'approval_checking', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'approval_processing', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'approval_approved', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'manual_order_created', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'booking_approved', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'ticket_issued', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'payment_received', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'payment_due_reminder', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'supplier_payable_reminder', notifyCustomer: false, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'schedule_change', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'booking_canceled', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'void_done', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'reissue_done', notifyCustomer: true, notifyAdmin: false, notifySupplier: true, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'refund_paid', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'refund_requested', notifyCustomer: true, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'refund_approved', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'upcoming_flight', notifyCustomer: true, notifyAdmin: false, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'daily_ledger_summary', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: false, whatsappEnabled: true, isEnabled: true },
  { eventType: 'backup_failed', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
  { eventType: 'agent_booking_submitted', notifyCustomer: false, notifyAdmin: true, notifySupplier: false, notifyAgent: false, smsEnabled: true, emailEnabled: true, whatsappEnabled: true, isEnabled: true },
