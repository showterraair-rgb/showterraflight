...
export const PERMISSIONS = {
  ...
  'livestream:view': 'View live stream schedules and status',
  'livestream:manage': 'Create, publish, go live, and end streams',
...
const ACCOUNTANT_PERMS = [
  ...
  'cms:view', 'livestream:view', 'audit:view', 'notifications:view',
...
const ADMINISTRATOR_PERMS = [
  ...
  'accounts:manage',
  'cms:manage',
  'livestream:view', 'livestream:manage',
...
export const PERMISSION_MODULES = [
  ...
  { key: 'livestream', label: 'Live Stream', permissions: ['livestream:view', 'livestream:manage'] },
